...
import 'pages/cocircle_page.dart';
...
class _MainNavigationState extends State<MainNavigation>
  ...
  final List<List<Color>> _pageGradients = [
    ...
    [const Color(0xFF6366F1), const Color(0xFF06B6D4)], // Discover: indigo→cyan
  ...
  void initState() {
    ...
    _iconControllers = List.generate(
      ...
      (index) => AnimationController(
        vsync: this,
        duration: const Duration(milliseconds: 120), // Press timing
      ),
    );
  }
  ...
  void _onTabTapped(int index) {
    if (index != _currentIndex) {
      HapticFeedback.selectionClick(); // Chip/tab haptic
      ...
      _pageController.animateToPage(
        index,
        duration: const Duration(milliseconds: 220), // Route timing
